...
/**
 * Clase que representa la etiqueta EtiquetaAsambleas para "decorar" (agregarle
 * a) una
 * tarea
 * Extiende de TareasDecorator
 */
public class EtiquetaAsambleas extends TareasDecorator {

    /**
     * Constructor de la clase EtiquetaAsambleas
     * 
     * @param tarea La tarea a decorar con la etiqueta asambleas
     */
    public EtiquetaAsambleas(Tarea tarea) {
        super(tarea);
    }

    /**
     * Obtiene la descripción de la tarea con la etiqueta asambleas
     * 
     * @return La descripción de la tarea con la etiqueta asambleas
     */
    @Override
    ...
    public String getEtiquetas() {
        return tarea.getEtiquetas() + "#Asambleas-";
    }
