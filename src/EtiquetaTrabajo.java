...
/**
 * Clase que representa la etiqueta EtiquetaTrabajo para "decorar" (agregarle a)
 * una tarea
 * Extiende de TareasDecorator
 */
public class EtiquetaTrabajo extends TareasDecorator {

    /**
     * Constructor de la clase EtiquetaTrabajo
     * 
     * @param tarea La tarea a decorar con la etiqueta Trabajo
     */
    public EtiquetaTrabajo(Tarea tarea) {
        super(tarea);
    }

    /**
     * Obtiene la descripción de la tarea con la etiqueta Trabajo
     * 
     * @return La descripción de la tarea con la etiqueta Trabajo
     */
    @Override
    ...
    public String getEtiquetas() {
        return tarea.getEtiquetas() + "#Trabajo-";
    }
