...
/**
 * Clase que representa la etiqueta EtiquetaEntretenimiento para "decorar"
 * (agregarle a)
 * una tarea
 * Extiende de TareasDecorator
 */
public class EtiquetaEntretenimiento extends TareasDecorator {

    /**
     * Constructor de la clase EtiquetaEntretenimiento
     * 
     * @param tarea La tarea a decorar con la etiqueta entretenimiento
     */
    public EtiquetaEntretenimiento(Tarea tarea) {
        super(tarea);
    }

    /**
     * Obtiene la descripción de la tarea con la etiqueta entretenimiento
     * 
     * @return La descripción de la tarea con la etiqueta entretenimiento
     */
    @Override
    ...
    public String getEtiquetas() {
        return tarea.getEtiquetas() + "#Entretenimiento-";
    }
    ...
    /**
     * Obtiene la fecha de creación de la tarea a la que le agregamos etiquetas
     * 
    ...
    /**
     * Obtiene la fecha de vencimiento de la tarea a la que le agregamos etiquetas
     * 
