...
/**
 * Clase que representa la etiqueta EtiquetaSocial para "decorar" (agregarle a)
 * una tarea
 * Extiende de TareasDecorator
 */
public class EtiquetaSocial extends TareasDecorator {

    /**
     * Constructor de la clase EtiquetaSocial
     * 
     * @param tarea La tarea a decorar con la etiqueta Social
     */
    public EtiquetaSocial(Tarea tarea) {
        super(tarea);
    }

    /**
     * Obtiene la descripción de la tarea con la etiqueta Social
     * 
     * @return La descripción de la tarea con la etiqueta Social
     */
    @Override
    ...
    public String getEtiquetas() {
        return tarea.getEtiquetas() + "#Social-";
    }
