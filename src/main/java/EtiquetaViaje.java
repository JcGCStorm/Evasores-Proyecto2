...
/**
 * Clase que representa la etiqueta EtiquetaViaje para "decorar" (agregarle a)
 * una tarea
 * Extiende de TareasDecorator
 */
public class EtiquetaViaje extends TareasDecorator {

    /**
     * Constructor de la clase EtiquetaViaje
     * 
     * @param tarea La tarea a decorar con la etiqueta Viaje
     */
    public EtiquetaViaje(Tarea tarea) {
        super(tarea);
    }

    /**
     * Obtiene la descripción de la tarea con la etiqueta Viaje
     * 
     * @return La descripción de la tarea con la etiqueta Viaje
     */
    @Override
    ...
    public String getEtiquetas() {
        return tarea.getEtiquetas() + "#Viaje-";
    }
