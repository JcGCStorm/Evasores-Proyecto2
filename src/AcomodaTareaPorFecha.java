public class AcomodaTareaPorFecha implements AcomodaTareaStrategy {
  ...
  public void acomodaTarea(Tarea tarea) {
    ...
    // tareaPorFecha.sort((tarea1, tarea2) ->
    // tarea.getFechaVencimiento().compareTo(tarea.getFechaVencimiento()));
  }
}
// pues en cuanto terminen ustedes ya me los aviento, solo son metodos de
// ordenacion
// Vaaaa, entonces ya nomas es checar los otros metodos. Va que va man, si
// quieres ya mañana
