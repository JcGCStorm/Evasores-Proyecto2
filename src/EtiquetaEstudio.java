...
/**
 * Clase que representa la etiqueta EtiquetaEstudio para "decorar" (agregarle a)
 * una tarea
...
public class EtiquetaEstudio extends TareasDecorator {
    ...
    /**
     * Constructor de la clase EtiquetaEstudio
     * 
     * @param tarea La tarea a decorar con la etiqueta estudio
     */
    ...
    /**
     * Obtiene la descripción de la tarea con la etiqueta estudio
     * 
     * @return La descripción de la tarea con la etiqueta estudio
     */
    @Override
